@php
    ...
    $confirmUrl = env('NGROK_APP_URL') . '/api/auth/email-confirm/' . $user_id . '/' . $email;
@endphp
                ...
                <table cellpadding="0" cellspacing="0" width="600" bgcolor="#ffffff" style="border-radius: 4px; box-shadow: 0 0 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            ...
                            <p style="font-size: 16px; line-height: 24px; margin-bottom: 30px;">Thank you for joining our app. We look forward to providing you with great experiences.</p>
            
                            <p style="font-size: 16px; line-height: 24px; margin-bottom: 30px;">You can also click the button confirm account:</p>
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
